...
WELCOME_BACK_MSG = _("Welcome back. You have a reservation for the room {} from {} till {}. What else can I do for you?")
...
USER_CANNOT_BOOK = _("But you cannot reseve a room. A reservation already exist in your name which expires only by {}.")
...
CONFIRM_CANCELLATION = _("Do you want to confirm?")