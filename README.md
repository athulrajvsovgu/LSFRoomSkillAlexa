...
<table style="border-collapse: collapse; border: none;">
	<tr style="border: none;">
		<td style="border: none;"> 
			<figure align="center">
				<img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/1-off._TTH_.png">
				<figcaption align="center"><a href="./docs/room_search_date.md">Find room with date</a></figcaption>
			</figure>
			</td>
			<td> 
			<figure align="center">
				<img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/2-off._TTH_.png">
				<figcaption align="center"><a href="./docs/room_search_immediately.md">Find room immediately</a></figcaption>
			</figure>
			</td>
			<td> 
			<figure align="center">
				<img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/3-off._TTH_.png">
				<figcaption align="center"><a href="./docs/reserve_room.md">Reserve room</a></figcaption>
			</figure>
			</td>
			<td> 
			<figure align="center">
				<img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/4-off._TTH_.png">
				<figcaption align="center"><a href="./docs/cancel_reservation.md">Cancel reservation</a></figcaption>
			</figure>
			</td>
			<td> 
			<figure align="center">
				<img src=".https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/5-off._TTH_.png">
